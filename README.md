...
In the example described in this toolbox, we use a **Finite Impulse Response** (FIR) basis set, splitting the analysis in time window to investigate the contribution of experimental contrast over time. 
...
components derived from models of neural activation (normative baseline model, neural mass models...). 
